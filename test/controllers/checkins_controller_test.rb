...
class CheckinsControllerTest < ActionController::TestCase
  ...
  test "should create checkin" do
    assert_difference('Checkin.count') do
      post :create, checkin: { habit_id: @checkin.habit_id, happiness_score: @checkin.happiness_score, time: @checkin.time }
    end
  ...
  test "should update checkin" do
    patch :update, id: @checkin, checkin: { habit_id: @checkin.habit_id, happiness_score: @checkin.happiness_score, time: @checkin.time }
    assert_redirected_to checkin_path(assigns(:checkin))
  end
